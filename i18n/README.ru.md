...
**42 инструмента** · **391 REST-действие** · **368 эндпоинтов** · **17 WebSocket-каналов**
...
в 42 инструмента, которые ваш AI-агент может вызывать напрямую.
...
### Clients API — 28 инструментов, 315 действий
...
### Integration API — 11 инструментов, 72 действия
...
### Bot API — 2 инструмента, 4 действия
...
### События — 1 инструмент, 17 WebSocket-каналов
