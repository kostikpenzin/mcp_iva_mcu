...
export function createIntegrationConferencesTool(client: IvaApiClient): ToolDefinition {
  return createActionTool(
    ...
    },
    {
      ...
      add_participants: { apiType: "integration", method: "POST", path: "/conferences/{conferenceId}/participants/add", pathParams: ["conferenceId"], bodyParam: "participants" },
      ...
      remove_participants: { apiType: "integration", method: "POST", path: "/conferences/{conferenceId}/participants/remove", pathParams: ["conferenceId"], bodyParam: "participantIds" },
