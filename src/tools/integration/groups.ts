...
export function createIntegrationGroupsTool(client: IvaApiClient): ToolDefinition {
  return createActionTool(
    ...
    },
    {
      ...
      add_users: { apiType: "integration", method: "POST", path: "/groups/{groupId}/users/add", pathParams: ["groupId"], bodyParam: "userIds" },
      remove_users: { apiType: "integration", method: "POST", path: "/groups/{groupId}/users/remove", pathParams: ["groupId"], bodyParam: "userIds" },
    },
    client,
  );
}