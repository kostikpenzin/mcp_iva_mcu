...
export function createConferenceParticipantsTool(client: IvaApiClient): ToolDefinition {
  return createActionTool(
    ...
    },
    {
      ...
      add: { apiType: "clients", method: "POST", path: "/conference-sessions/{conferenceSessionId}/participants/add", pathParams: ["conferenceSessionId"], bodyParam: "participants", bodyWrapper: "participants" },
      ...
      remove: { apiType: "clients", method: "POST", path: "/conference-sessions/{conferenceSessionId}/participants/remove", pathParams: ["conferenceSessionId"], bodyParam: "participantIds", bodyWrapper: "participantIds" },
      disconnect: { apiType: "clients", method: "POST", path: "/conference-sessions/{conferenceSessionId}/participants/disconnect", pathParams: ["conferenceSessionId"], bodyParam: "participantIds", bodyWrapper: "participantIds" },
