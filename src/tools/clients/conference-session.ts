...
export function createConferenceSessionTool(client: IvaApiClient): ToolDefinition {
  return createActionTool(
    ...
    ],
    {
      ...
      state: {
        type: "string",
        description: "Session state filter for action 'find': NO_STARTED, ACTIVE or STOPPED",
      },
      states: {
        type: "array",
        items: { type: "string" },
        description: "Array of session state filters for action 'find_sessions': NO_STARTED, ACTIVE, STOPPED",
      },
    ...
    },
    {
      ...
      find: { apiType: "clients", method: "GET", path: "/conference-sessions", queryParams: ["nameContains", "dateFrom", "dateTo", "limit", "offset", "orderAsc", "state", "conferenceId"] },
      find_rooms: { apiType: "clients", method: "GET", path: "/conference-sessions/rooms", queryParams: ["limit", "offset"] },
      find_sessions: { apiType: "clients", method: "GET", path: "/conference-sessions/sessions", queryParams: ["nameContains", "dateFrom", "dateTo", "limit", "orderAsc", "conferenceId", "states"] },
    ...
    client,
    {
      ...
      find_sessions: "Find conference sessions (alternative search). Optional: nameContains, dateFrom, dateTo, limit, orderAsc, conferenceId, states (array of NO_STARTED/ACTIVE/STOPPED). Response is enriched with actualDurationMs / actualDuration for finished sessions.",
