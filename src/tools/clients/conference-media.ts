...
export function createConferenceMediaTool(client: IvaApiClient): ToolDefinition {
  return createActionTool(
    ...
    },
    {
      ...
      set_layout: { apiType: "clients", method: "POST", path: "/conference-sessions/{conferenceSessionId}/media/layout", pathParams: ["conferenceSessionId"], bodyParam: "layout" },
      set_media_profile: { apiType: "clients", method: "POST", path: "/conference-sessions/{conferenceSessionId}/media/media-profile", pathParams: ["conferenceSessionId"], bodyParam: "mediaProfile" },
      set_broadcast_language: { apiType: "clients", method: "POST", path: "/conference-sessions/{conferenceSessionId}/media/broadcast-language", pathParams: ["conferenceSessionId"], bodyParam: "broadcastLanguage" },
      set_original_volume: { apiType: "clients", method: "POST", path: "/conference-sessions/{conferenceSessionId}/media/original-volume", pathParams: ["conferenceSessionId"], bodyParam: "originalVolume" },
      set_screen_orientation: { apiType: "clients", method: "POST", path: "/conference-sessions/{conferenceSessionId}/media/screen-orientation", pathParams: ["conferenceSessionId"], bodyParam: "screenOrientation" },
      set_translation_direction: { apiType: "clients", method: "POST", path: "/conference-sessions/{conferenceSessionId}/media/translation-direction", pathParams: ["conferenceSessionId"], bodyParam: "translationDirection" },
    },
    client,
  );
}