...
export function createConferenceMediaTool(client: IvaApiClient): ToolDefinition {
  return createActionTool(
    ...
    },
    {
      ...
      set_media_profile: { apiType: "clients", method: "POST", path: "/conference-sessions/{conferenceSessionId}/media/media-profile", pathParams: ["conferenceSessionId"], bodyParam: "mediaProfile", bodyWrapper: "mediaProfile" },
      set_broadcast_language: { apiType: "clients", method: "POST", path: "/conference-sessions/{conferenceSessionId}/media/broadcast-language", pathParams: ["conferenceSessionId"], bodyParam: "broadcastLanguage", bodyWrapper: "broadcastLanguage" },
      set_original_volume: { apiType: "clients", method: "POST", path: "/conference-sessions/{conferenceSessionId}/media/original-volume", pathParams: ["conferenceSessionId"], bodyParam: "originalVolume", bodyWrapper: "originalVolume" },
