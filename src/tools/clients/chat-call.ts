...
export function createChatCallTool(client: IvaApiClient): ToolDefinition {
  return createActionTool(
    ...
    },
    {
      ...
      set_media_state: { apiType: "clients", method: "POST", path: "/chat-calls/{chatRoomId}/media-state", pathParams: ["chatRoomId"], bodyParam: "mediaState" },
      send_dtmf: { apiType: "clients", method: "POST", path: "/chat-calls/{chatRoomId}/participants/{profileId}/send-dtmf", pathParams: ["chatRoomId", "profileId"], bodyParam: "dtmfData" },
