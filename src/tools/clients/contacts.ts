...
export function createContactsTool(client: IvaApiClient): ToolDefinition {
  return createActionTool(
    ...
    ],
    {
      ...
      profileIds: { type: "array", items: { type: "string" }, description: "Profile UUIDs to invite" },
    ...
    },
    {
      ...
      get_changes: { apiType: "clients", method: "GET", path: "/contacts/changes", queryParams: ["dateFrom", "limit"] },
      ...
      get_users_presence: { apiType: "clients", method: "POST", path: "/contacts/presences/find-for-users", bodyParam: "presenceUserIds" },
      invite: { apiType: "clients", method: "POST", path: "/contacts/invite", bodyParam: "profileIds" },
      reject_invitation: { apiType: "clients", method: "POST", path: "/contacts/invitations/reject", bodyParam: "contactIds" },
      ...
      remove_contacts: { apiType: "clients", method: "POST", path: "/contacts/remove", bodyParam: "contactIds" },
    ...
    client,
    {
      ...
      invite: "Пригласить пользователей в контакты по UUID профилей. / Invite users to contacts by profile UUIDs.",
