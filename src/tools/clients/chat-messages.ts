...
export function createChatMessagesTool(client: IvaApiClient): ToolDefinition {
  return createActionTool(
    ...
    },
    {
      ...
      delete_multiple: { apiType: "clients", method: "POST", path: "/chats/{chatRoomId}/messages/remove", pathParams: ["chatRoomId"], bodyParam: "messageIds", bodyWrapper: "messageIds" },
      ...
      star: { apiType: "clients", method: "POST", path: "/chats/{chatRoomId}/star-messages", pathParams: ["chatRoomId"], bodyParam: "messageIds", bodyWrapper: "messageIds" },
      unstar: { apiType: "clients", method: "POST", path: "/chats/{chatRoomId}/unstar-messages", pathParams: ["chatRoomId"], bodyParam: "messageIds", bodyWrapper: "messageIds" },
